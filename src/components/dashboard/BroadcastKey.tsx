  ...
  return (
    <section className="w-full max-w-[1180px] mx-auto mt-6 px-6 flex flex-wrap gap-4 items-center justify-between text-xs text-[#8493AD]">
      <div className="flex flex-wrap gap-3 items-center">
        <div className="flex items-center gap-2 bg-[#111A2B] border border-white/5 py-1.5 px-3 rounded-lg">
          <span className="w-2.5 h-2.5 rounded-sm bg-[#2DE89A]"></span>
          <span className="font-semibold text-white">FOX</span>
          <span className="w-2.5 h-2.5 rounded-sm bg-[#5AA9FF]"></span>
          <span className="font-semibold text-white">FS1</span>
          <span className="text-[11px] text-[#5E6C84]">— English TV</span>
        </div>

        <div className="flex items-center gap-2 bg-[#111A2B] border border-white/5 py-1.5 px-3 rounded-lg">
          <span className="w-2.5 h-2.5 rounded-sm bg-[#9A82FF]"></span>
          <span className="font-semibold text-white">Telemundo</span>
          <span className="w-2.5 h-2.5 rounded-sm bg-[#F2A65A]"></span>
          <span className="font-semibold text-white">Universo</span>
      ...
      <div className="flex items-center gap-2 self-end sm:self-auto">
        ...
        <Button
          variant="secondary"
          size="icon"
          onClick={() => handleOpenShare(`https://twitter.com/intent/tweet?text=${encodeURIComponent(getShareText())}&url=${encodeURIComponent(getShareUrl())}`)}
          className="size-8 bg-[#111A2B] border border-white/10 hover:border-[#1FB87A] hover:text-white"
          title="Share on X"
        >
        ...
        <Button
          variant="secondary"
          size="icon"
          onClick={() => handleOpenShare(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(getShareUrl())}&quote=${encodeURIComponent(getShareText())}`)}
          className="size-8 bg-[#111A2B] border border-white/10 hover:border-[#1FB87A] hover:text-white"
